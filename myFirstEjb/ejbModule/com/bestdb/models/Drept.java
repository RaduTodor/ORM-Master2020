 ...
 */
@Entity
@NamedQuery(name="Drept.findAll", query="SELECT r FROM Drept r")
public class Drept implements Serializable {
	...
	public Drept(String rightName, String rightDescription) {
